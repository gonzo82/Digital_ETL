...
def obtain_adwords_report(client):
    ...
    report = {
        ...
        'downloadFormat': 'CSV',
        'selector': {
            'fields': ['CampaignId', 'AdGroupId', 'Id', 'CriteriaType', 'Criteria', 'FinalUrls', 'Impressions',
                       'Clicks', 'Cost']
        }
    }
...
def main(client):
    ...
    report_query = (adwords.ReportQueryBuilder()
                    .Select('CampaignId', 'AdGroupId', 'Id', 'Criteria',
                            ...
                            'Cost')
                    # .Select('cuenta', 'campaña', 'estadoDeLaCampaña', 'mes',
...
if __name__ == '__main__':
    ...
    obtain_adwords_report(adwords_client)
